...
#txt = amazon.nokia.lumia.reviews
txt = readLines("C:\\Users\\Nik\\Downloads\\amazon nokia lumia reviews.txt")
...
#From Srinivas to Everyone:  04:55 PM
windows()
...
#From Srinivas to Everyone:  04:56 PM
